...
export const rewriteRegex = /"https?:\/\/(?:www)?steemit\.com((\/)(((\w+\/)?@\w+\/\w+)|(@\w+(\/(comments|followers|followed|reblogs|feed|transfers|activity))?)|((trending|created|active|hot|promoted)(\/\w+)?))?)?"/g;

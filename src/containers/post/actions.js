...
var Actions = React.createClass({
	...
	render: function(){
		...
		return (<ul>
				<li><a onClick={() => this.vote(voter, post.author, post.permlink, 10000)}><i className="icon icon-sm material-icons">thumb_up</i></a> {numeral(post.net_votes).format('0,0')}<span className="hidden-xs"> Likes</span></li>

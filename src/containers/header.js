		...
		return (
			<header>
				<div className="top-nav">
					{!this.props.app.sidebarIsVisible && <a href="#" onClick={function() { this.props.showSidebar()}}><i className="icon icon-md icon-menu material-icons">menu</i></a>}
					{this.props.app.sidebarIsVisible && <a href="#" onClick={function() { this.props.hideSidebar()}}><i className="icon icon-md icon-menu material-icons">arrow_back</i></a>}
				...
				{menu == 'primary' && <ul className="app-nav">
					...
					<li><a href="#" onClick={function() { this.props.setMenu('secondary')}}><i className="icon icon-md material-icons">expand_more</i></a></li>
				</ul>}
				{menu == 'secondary' && <ul className="app-nav">
					...
					<li><a href="#" onClick={function() { this.props.setMenu('primary')}}><i className="icon icon-md material-icons">expand_less</i></a></li>
				</ul>}

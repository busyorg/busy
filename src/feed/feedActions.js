...
const GET_FEED_CONTENT = 'GET_FEED_CONTENT';
const GET_FEED_CONTENT_SUCCESS = 'GET_FEED_CONTENT_SUCCESS';

const GET_MORE_FEED_CONTENT = 'GET_MORE_FEED_CONTENT';
const GET_MORE_FEED_CONTENT_SUCCESS = 'GET_MORE_FEED_CONTENT_SUCCESS';

const GET_USER_FEED_CONTENT = 'GET_USER_FEED_CONTENT';
const GET_USER_FEED_CONTENT_SUCCESS = 'GET_USER_FEED_CONTENT_SUCCESS';

const GET_MORE_USER_FEED_CONTENT = 'GET_MORE_USER_FEED_CONTENT';
const GET_MORE_USER_FEED_CONTENT_SUCCESS = 'GET_MORE_USER_FEED_CONTENT_SUCCESS';

const FEED_HAS_NO_MORE = 'FEED_HAS_NO_MORE';
